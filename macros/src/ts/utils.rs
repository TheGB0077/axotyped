...
use crate::ts::deps::Dependencies;
                    ...
                    match &*key.to_string() {
                        ...
                        x => {
                            if cfg!(not(feature = "no-serde-warnings")) {
                                let tokens = crate::ts::attr::skip_until_next_comma($input);

                                crate::ts::utils::warning::print_warning(
                                ...
                                crate::ts::attr::skip_until_next_comma($input);
                            }
                        }
                    }
